...
function OnTick()
 ...
 if _G.AstorAramLoaded and not ERROR then
...
function ChatHandler:__init()
 ...
 if Menu.chat.enabled and FileExist(FILE_PATH .. "\\chat.txt") then
...
function ChatHandler:Load()
 ...
 if FileExist(path) then
  ...
  DownloadFile("http://pastebin.com/download.php?i=PPSeuMPw", path, function()

    self:Print("Minimal chat file downloaded, reloading.")
    self:Load()
